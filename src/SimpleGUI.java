...
public class SimpleGUI extends JFrame implements ActionListener, ItemListener, ChangeListener {
    ...
    private void init() {
        ...
        JButton obamaButton = new JButton("Obama");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (source instanceof JButton) {
            ...
            if (text.equals("Send")) {
                ...
                newWindow.setSize(150, 100);
                newWindow.setLocation(150, 10);
            ...
            } else if (text.equals("Obama")) {
                JFrame newWindow = new JFrame();
                newWindow.setSize(800, 1089);
                newWindow.setLocation(150, 50);
                JLabel label = new JLabel();
                label.setIcon(new ImageIcon("src\\Official_portrait_of_Barack_Obama.jpg"));
                newWindow.add(label);
                newWindow.setVisible(true);
            }
    ...
    public void stateChanged(ChangeEvent e) {
        textArea.setText(Integer.toString(((JSlider) e.getSource()).getValue()));
    }
}
